...
class MainWindow(MainWindowUi):
    ...
    def __init__(self):
        ...
        # 定义各文本显示框中显示消息的类型
        self.danmu_message_type = ('chatmsg', 'uenter', 'newblackres', 'blab')    # 弹幕文本框显示的消息类型列表
        ...
        self.message_css = ('<style type="text/css">\n'
                            ...
                            '.gn, .hits, .noble, .content { color:#FF5500; }\n'    # 橙色
                            '.ct { color:#000000; }\n'    # 黑色
        ...
        self.message_table_key = {
            ...
            'spbc': ('time', 'type', 'sn', 'dn', 'gn',
                     'gc', 'drid', 'gb', 'es', 'gfid'),
            'anbc': ('time', 'type', 'uid', 'unk', 'drid',
                     'donk', 'gvnk', 'nl', 'noble'),
    ...
    def get_display_text(self, msg):    # 将字典型消息转换成可用于在文本框中显示的html文本
        try:
            ...
            if msg['type'] == 'chatmsg':    # 弹幕消息
                ...
                text.append(u'<span class="txt">粉丝等级升级到</span>')
