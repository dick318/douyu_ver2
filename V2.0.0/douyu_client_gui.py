...
class DanmuWidget(QWidget):    # 构建弹幕窗体
    def __init__(self, parent=None):
        ...
        self.hide_newblackres = QCheckBox(u'屏蔽禁言消息', self)
        ...
        self.danmu_care_list.setToolTip(
            u'水友名称，用逗号分割，被关注的水友名称用红色显示，并在记录窗中显示')
        ...
        danmu_config_layout.addWidget(self.hide_newblackres)
        ...
        danmu_layout_spacer = 10
        danmu_widget_layout.setSpacing(danmu_layout_spacer)
...
class BroadcastWidget(QWidget):    # 构建广播窗体
    def __init__(self, parent=None):
        ...
        self.only_show_superrocket_noble = QCheckBox(u'只看超级火箭和开通贵族', self)
        self.superrocket_noble_remind = QCheckBox(u'超级火箭和开通贵族宝箱提醒', self)
        self.plane_rocket_remind = QCheckBox(u'飞机和火箭宝箱提醒', self)
        ...
        broadcast_config_layout.addWidget(self.only_show_superrocket_noble)
        broadcast_config_layout.addWidget(self.superrocket_noble_remind)
        broadcast_config_layout.addWidget(self.plane_rocket_remind)
...
class ConfigWidget(QWidget):    # 构建设置窗体
    def __init__(self, parent=None):
        ...
        self.open_remind_duration_tip = QLabel(u'秒（0--900，0表示持续显示）', self)
        ...
        self.title_remind_duration_tip = QLabel(u'秒（0--60，0表示持续显示）', self)
        ...
        self.gift_remind_duration_tip = QLabel(u'秒（0--180，0表示持续显示）', self)
        ...
        spinbox_width = DIGIT_SIZE.width() * 6
        self.open_remind_duration.setFixedWidth(spinbox_width)
        self.title_remind_duration.setFixedWidth(spinbox_width)
        self.gift_remind_duration.setFixedWidth(spinbox_width)
        self.open_remind_duration.setRange(0, 900)
        self.title_remind_duration.setRange(0, 60)
...
class TrayIcon(QSystemTrayIcon):    # 构建托盘菜单
    def __init__(self, parent=None):
        ...
        self.action_superrocket_remind = self.tray_menu.addAction(u'超级火箭提醒')
        self.action_rocket_remind = self.tray_menu.addAction(u'飞机火箭提醒')
        self.tray_menu.addSeparator()
        ...
        self.action_rocket_remind.setCheckable(True)
