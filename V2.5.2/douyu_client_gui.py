...
class RecordWidget(QWidget):    # 构建记录窗体
    def __init__(self, parent=None):
        ...
        self.option_blab = QRadioButton(u'粉丝牌升级', self.message_type)
        self.option_setadminres = QRadioButton(u'任免房管', self.message_type)
        ...
        self.option_rnewbc = QRadioButton(u'续费贵族', self.message_type)
        self.option_cthn = QRadioButton(u'喇叭消息', self.message_type)
        self.option_ssd = QRadioButton(u'系统广播', self.message_type)
        ...
        self.tips = QLabel(u'注：若查询结果超过10000条，则只显示最近的10000条。', self)
        ...
        self.selected_message_type.addButton(self.option_blab, 3)
        self.selected_message_type.addButton(self.option_setadminres, 4)
        self.selected_message_type.addButton(self.option_dgb, 5)
        self.selected_message_type.addButton(self.option_spbc, 6)
        self.selected_message_type.addButton(self.option_anbc, 7)
        self.selected_message_type.addButton(self.option_rnewbc, 8)
        self.selected_message_type.addButton(self.option_cthn, 9)
        self.selected_message_type.addButton(self.option_ssd, 10)
        self.selected_message_type.addButton(self.option_rss, 11)
        ...
        message_type_layout.addWidget(self.option_blab, 1, 0)
        message_type_layout.addWidget(self.option_setadminres, 1, 1)
        message_type_layout.addWidget(self.option_dgb, 1, 2)
        message_type_layout.addWidget(self.option_spbc, 2, 0)
        message_type_layout.addWidget(self.option_anbc, 2, 1)
        message_type_layout.addWidget(self.option_rnewbc, 2, 2)
        message_type_layout.addWidget(self.option_cthn, 3, 0)
        message_type_layout.addWidget(self.option_ssd, 3, 1)
        message_type_layout.addWidget(self.option_rss, 3, 2)
        ...
        condition_layout.addWidget(self.not_begin, 0, 2)
        condition_layout.addWidget(self.end_time, 1, 1)
        condition_layout.addWidget(self.not_end, 1, 2)
        condition_layout.addWidget(self.room_num, 2, 1, 1, 2)
        condition_layout.addWidget(self.view_way, 3, 1, 1, 2)
        condition_layout.addWidget(self.noble_level, 4, 1, 1, 2)
        condition_layout.addWidget(self.user_name, 5, 1, 1, 2)
        condition_layout.addWidget(self.danmu_text, 6, 1, 1, 2)
        condition_layout.addWidget(self.gift_name, 7, 1, 1, 2)
        condition_layout.addWidget(self.anthor_name, 8, 1, 1, 2)
    ...
    def selected_message_type_event(self, event=None):
        ...
        if sele_index == 0:    # 查询弹幕消息
            ...
            self.user_name.setEnabled(True)    # 用户名称可用
        elif sele_index == 3:    # 查询粉丝牌升级消息
            self.user_name.setEnabled(True)    # 用户名称可用
        elif sele_index == 4:    # 查询任免房管消息
            self.user_name.setEnabled(True)    # 用户名称可用
        elif sele_index == 5:    # 查询房间礼物
            self.noble_level.setEnabled(True)    # 贵族等级可用
            self.user_name.setEnabled(True)    # 用户名称可用
            self.gift_name.setEnabled(True)    # 礼物名称可用
        elif sele_index == 6:    # 查询广播礼物
            self.user_name.setEnabled(True)    # 用户名称可用
            self.gift_name.setEnabled(True)    # 礼物名称可用
            self.anthor_name.setEnabled(True)     # 主播名称可用
        elif sele_index == 7:    # 查询开通贵族
            self.noble_level.setEnabled(True)    # 贵族等级可用
            self.user_name.setEnabled(True)    # 用户名称可用
            self.anthor_name.setEnabled(True)    # 主播名称可用
        elif sele_index == 8:    # 查询续费贵族
            self.noble_level.setEnabled(True)    # 贵族等级可用
            self.user_name.setEnabled(True)    # 用户名称可用
            self.anthor_name.setEnabled(True)    # 主播名称可用
        elif sele_index == 9:    # 查询喇叭消息
            self.user_name.setEnabled(True)    # 用户名称可用
            self.anthor_name.setEnabled(True)    # 主播名称可用
        elif sele_index == 10:    # 查询系统广播
            pass
        elif sele_index == 11:    # 查询开关播消息
            pass
