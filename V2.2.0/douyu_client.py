        ...
        try:
            ...
            if msg['type'] == 'chatmsg':
                ...
                style = ('style="color:#FF0000"'
                         if msg['nn'] and (msg['nn'] == self.room_owner or msg['nn'] in self.danmu_care_list)
                         else '')
                ...
                for emot in emot_list:
                    ...
                    if (img_num >= 1 and img_num <= 17) or (img_num >= 101 and img_num <= 137):
                        img = '<img class="emotion" src="%s" />' % (os.path.join(self.emotion_dir, emot[6:-1] + '.png'))
                ...
                style = ('style="color:#FF0000"'
                         if msg['nn'] and msg['nn'] in self.gift_care_list
                         else '')
                text.append(u'<span class="level">[%s]</span>' % msg['level'])
                text.append((u'<span class="nl">[%s]</span>' % msg['nl']) if msg['nl'] else '')
                text.append(u'<span class="nn" %s>%s</span>' % (style, msg['nn']))
                ...
                style = ('style="color:#FF0000"'
                         if msg['sn'] and msg['sn'] in self.broadcast_care_list
                         else '')
